  ...
  return (
    <article className='flex-1 flex-col w-full h-full gap-2 flex-grow'>
      <header className='flex bg-blue-900 w-full items-center justify-between p-8'>
        <h1 className='text-white text-4xl'>Sidebar do App 2</h1>
      ...
      <main className='flex flex-col w-full gap-2 p-2'>
        ...
        <button onClick={() => setToken(undefined)} className='rounded border-solid border-2 border-white text-white p-2 w-28'>Set Token</button>
      </main>
    </article>
  )
}
